...
import 'package:lakshmiai/main.dart';
            ...
            SizedBox(height: 40),
             ...
             Row(
              children: [
                 ...
                 InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>microinve()));
                  },
                 ...
                 InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>chatbotpge()));
                  },
